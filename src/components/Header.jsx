    ...
    <header className={`fixed top-0 left-0 w-full z-[100] transition-all duration-700 ${
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          {/* NOUVEAU BOUTON REVIEWS */}
          <Link to="/reviews" className="text-white text-[10px] uppercase tracking-[0.3em] font-bold hover:text-[#D4AF37] transition-colors">Reviews</Link>
        ...
        <div className={`fixed inset-0 bg-[#1a1008] transition-all duration-500 z-[105] ${isMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 invisible'}`}>
          <div className="flex flex-col pt-32 px-10 gap-8 h-full overflow-y-auto pb-20">
            ...
            {/* LIEN REVIEWS MOBILE */}
            <Link to="/reviews" onClick={() => setIsMenuOpen(false)} className="text-white text-2xl font-serif italic tracking-widest border-b border-white/5 pb-4">Client Reviews</Link>
